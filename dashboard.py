...
class VIMMO:
    def __init__(self,root):
        ...
        button_ai = Button(mleft_menu,highlightthickness=4,highlightbackground='#494443',text='Maaş Tahmin A.I',command=self.payment_ai,font=('Biryani Light',15),bg='#3E3C3C',fg='#0F0A0A',bd=1,cursor='hand2').pack(side=TOP,fill=X)
        button_exit = Button(mleft_menu,highlightthickness=7,highlightbackground='#494443',text='Çıkış',font=('Biryani Light',15),bg='#C8A109',fg='#0F0A0A',bd=1,cursor='hand2').pack(side=TOP,fill=X)
